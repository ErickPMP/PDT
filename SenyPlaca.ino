...
ISR(TIMER0_COMPA_vect){          // timer 0  (cada 1 mS)   
 ...
 if (Out1 >= 0.0) {  Out1a = Out1;digitalWrite(D4,HIGH);digitalWrite(D5,LOW);OCR2B  =  Out1a;} // D4 y D5 Compuerta AND seno POSITIVO
else { Out1b = abs(Out1);digitalWrite(D4,LOW);digitalWrite(D5,HIGH);OCR2B  =  abs(Out1);} // D4 y D5 Compuerta AND seno NEGATIVO
