...
if (u >= 0.0) {  Out2a = Out2;digitalWrite(D10,HIGH);digitalWrite(D9,LOW);OCR2A=u;SensorC=sen1;} // D10 y D9 Compuerta AND seno POSITIVO
else { Out2b = abs(Out2);digitalWrite(D10,LOW);digitalWrite(D9,HIGH);OCR2A=abs(u);SensorC=-sen1;} // D10 y 9 Compuerta AND seno NEGATIVO
...
void loop() {
  ...
  //**********************Leyendas*********************
  Serial.println("SetPoint,Corriente");
