...
float e,u,un,en,SPo,SensorC=0,IOut,IOut_1,eKp;
...
SPo=100.0*sin(2.0*PI*0.5*t);
//if(SPo>SensorC){e=SPo-SensorC;en=e;}
//else{e=SensorC-SPo;en=-e;}
if (SPo >= 0.0) {SPo=SPo;}
else {SPo=-SPo;}
e=SPo-current_mA1;
